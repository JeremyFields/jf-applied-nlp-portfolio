...
This repository contains a collection of end-to-end NLP projects focusing on pipeline engineering, linguistic analysis, and model implementation.

## Projects

### 1. [End-to-End Preprocessing Pipeline](./01-preprocessing/)
**Core Challenge:** Transforming unstructured HTML into ML-ready feature sets.
